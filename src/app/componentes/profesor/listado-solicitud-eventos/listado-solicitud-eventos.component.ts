...
@Component({
  selector: 'app-listado-solicitud-eventos',
  templateUrl: './listado-solicitud-eventos.component.html',
  styleUrls: ['./listado-solicitud-eventos.component.css']
})
export class ListadoSolicitudEventosComponent implements OnInit {
  token: string
  eventos: Evento[]
  solicitudes: Evento[]
  pageEvento: number;
